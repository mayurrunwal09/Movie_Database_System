        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Movie_Relase_Country = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_movie_Casts_Actors_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Actors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_movie_Casts_Genres_GenresId",
                        column: x => x.GenresId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_movie_Directions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_movie_Directions_Directors_DirectorId",
                        column: x => x.DirectorId,
                        principalTable: "Directors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_movie_Directions_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movie_Genres_Genres_GenresId",
                        column: x => x.GenresId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewerStar = table.Column<double>(type: "float", nullable: false),
                    No_Of_Ratings = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rating_Reviewers_ReviewerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_movie_Casts_ActorId",
                table: "movie_Casts",
                column: "ActorId");

            migrationBuilder.CreateIndex(
                name: "IX_movie_Casts_GenresId",
                table: "movie_Casts",
                column: "GenresId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_movie_Directions_DirectorId",
                table: "movie_Directions",
                column: "DirectorId");

            migrationBuilder.CreateIndex(
                name: "IX_movie_Directions_MovieId",
                table: "movie_Directions",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_Movie_Genres_GenresId",
                table: "Movie_Genres",
                column: "GenresId");
